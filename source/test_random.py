...
def read_topo(topo_name, adjust_factor_in=0.5):
    ...
    topo_name_map_file_path['A'] = './data/topologies/random_sampled_topos/VisionNet_topology.xlsx'
    topo_name_map_file_path['B'] = './data/topologies/random_sampled_topos/Globalcenter_topology.xlsx'
    topo_name_map_file_path['C'] = './data/topologies/random_sampled_topos/Tinet_topology.xlsx'
    topo_name_map_file_path['D'] = './data/topologies/random_sampled_topos/Cogentco_topology.xlsx'
    topo_name_map_file_path['E'] = './data/topologies/random_sampled_topos/KDL_topology.xlsx'
...
# if __name__ == "__main__":
#     topo=read_topo("A", adjust_factor=0.5)
#     print("Finish_test!")
